...
import { getUsers, getUserById, getUserByEmail, createUser, updateUser, deleteUser, searchUserByFullName } from '../controllers/users.controller.js';
import { auth, requiresAdmin } from '../middlewares/auth.middleware.js';

const router = Router();

router.get('/search', auth, requiresAdmin, searchUserByFullName); //admin
